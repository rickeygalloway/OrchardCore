...
namespace IH.OrchardCore.COD10.Drivers
{
    
   public class ContentAppInstanceFieldDisplayDriver : ContentFieldDisplayDriver<ContentAppInstanceField>
    {
        public ContentAppInstanceFieldDisplayDriver(IStringLocalizer<ContentAppInstanceFieldDisplayDriver> localizer)
        {
            T = localizer;
        }
        ...
        public override IDisplayResult Display(ContentAppInstanceField field, BuildFieldDisplayContext context)
        {
            return Initialize<DisplayContentAppInstanceFieldViewModel>(GetDisplayShapeType(context), model =>
            {
                model.Field = field;
        ...
        public override IDisplayResult Edit(ContentAppInstanceField field, BuildFieldEditorContext context)
        {
            return Initialize<EditContentAppInstanceFieldViewModel>(GetEditorShapeType(context), model =>
            {
                var settings = context.PartFieldDefinition.Settings.ToObject<ContentAppInstanceFieldSettings>();
        ...
        public override async Task<IDisplayResult> UpdateAsync(ContentAppInstanceField field, IUpdateModel updater, UpdateFieldEditorContext context)
        {
